...
// //           <p className="md:w-200 w-100 mx-auto mt-5 text-gray-400 ">
...
//       { name: "React", icon: "https://cdn-icons-png.flaticon.com/128/15484/15484268.png" },
//       { name: "Tailwind CSS", icon: "https://i.ibb.co.com/27Mj8g12/OIP-1-removebg-preview.png" },
//       { name: "Next.js", icon: "https://cdn-icons-png.flaticon.com/128/5968/5968322.png" },
//     ],
//   },
...
//       { name: "Express.js", icon: "https://cdn-icons-png.flaticon.com/128/15484/15484293.png" },
//       { name: "MongoDB", icon: "https://i.ibb.co.com/8nhYWct5/mongodb-logo-icon-170943.webp" },
//       { name: "Firebase", icon: "https://i.ibb.co.com/SwFDy5q9/OIP-3-removebg-preview.png" },
//       { name: "JWT Auth", icon: "https://cdn-icons-png.flaticon.com/128/3135/3135715.png" },
//     ],
//   },
...
//     skills: [
//       { name: "VS Code", icon: "https://cdn-icons-png.flaticon.com/128/906/906324.png" },
//       { name: "Git & GitHub", icon: "https://cdn-icons-png.flaticon.com/128/733/733553.png" },
//       { name: "Figma", icon: "https://cdn-icons-png.flaticon.com/128/5968/5968705.png" },
//       { name: "Postman", icon: "https://cdn-icons-png.flaticon.com/128/16025/16025213.png" },
//       { name: "Chrome DevTools", icon: "https://cdn-icons-png.flaticon.com/128/1048/1048943.png" },
//     ],
//   },
// ];
...
//         >
//           <p className="uppercase tracking-[0.3em] text-teal-400 text-sm">
//             My Skills
//           </p>
...
//             Categorized skills showcasing my expertise across the full development cycle.
//           </p>
//         </motion.div>
...
//               viewport={{ once: true }}
//               transition={{ duration: 0.6 }}
//               className="bg-[#0f1620] p-6 rounded-2xl border border-teal-500/10 
//               shadow-[0_0_15px_rgba(0,0,0,0.4)] hover:shadow-[0_0_25px_rgba(45,212,191,0.3)]
...
//                     border border-white/10 hover:border-teal-400/50 transition-all"
//                   >
//                     <img
//                       src={skill.icon}
...
const skillCategories = [
  {
    title: "Frontend Development",
    skills: [
       { name: "JavaScript", percent: 85, icon: "https://cdn-icons-png.flaticon.com/128/5968/5968292.png" },
           
      { name: "React", percent: 88, icon: "https://cdn-icons-png.flaticon.com/128/15484/15484268.png" },
      { name: "HTML5", percent: 95, icon: "https://cdn-icons-png.flaticon.com/128/1051/1051277.png" },
      { name: "CSS3", percent: 90, icon: "https://cdn-icons-png.flaticon.com/128/732/732190.png" },
 
      { name: "Tailwind CSS", percent: 92, icon: "https://i.ibb.co.com/27Mj8g12/OIP-1-removebg-preview.png" },
...

  {
    title: "Backend Development",
    skills: [
      { name: "Node.js", percent: 85, icon: "https://cdn-icons-png.flaticon.com/128/15484/15484303.png" },
      { name: "Express.js", percent: 80, icon: "https://i.ibb.co.com/wFzmVdJT/download-1.png" },
      { name: "MongoDB", percent: 75, icon: "https://i.ibb.co.com/8nhYWct5/mongodb-logo-icon-170943.webp" },
      { name: "Firebase", percent: 70, icon: "https://i.ibb.co.com/SwFDy5q9/OIP-3-removebg-preview.png" },
...

  {
    title: "Tools & Technologies",
    skills: [
      { name: "VS Code", percent: 95, icon: "https://cdn-icons-png.flaticon.com/128/906/906324.png" },
      { name: "GitHub", percent: 90, icon: "https://cdn-icons-png.flaticon.com/128/5968/5968866.png" },
      { name: "Netlify", percent: 90, icon: "https://i.ibb.co.com/TMYMN46W/images-removebg-preview-1.png" },
      { name: "Vercel", percent: 80, icon: "https://i.ibb.co.com/xNbjRm7/images-1-removebg-preview.png" },
      { name: "Figma", percent: 82, icon: "https://cdn-icons-png.flaticon.com/128/5968/5968705.png" },
                ...
                {category.skills.map((skill, i) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="ml-auto text-teal-400">{skill.percent}%</span>
                    </div>
